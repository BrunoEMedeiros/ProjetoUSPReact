...
export const oxfordBlue = '#0C1B33';
export const byzantium = '#7A306C';
export const lightSeaGreen = '#03B5AA';
export const mindaro = '#DBFE87';
export const byzantium_light = '#C66CB4';
export const byzantium_medium = '#BA4FA7';
